...
public class frmregistro extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        combotipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione", "Administrador", "Empleado" }));
        ...
        txtcc.setHorizontalAlignment(javax.swing.JTextField.LEFT);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (nombre.isEmpty()||apellido.isEmpty()||cc.isEmpty()||password.isEmpty()){
            JOptionPane.showMessageDialog(null, "Debe completar todos los datos");
        }else{
            if(tipousuario.equalsIgnoreCase("Seleccione")){
                JOptionPane.showMessageDialog(null, "Debe seleccionar tipo de usuario");
            }else{
                try {
                    String consulta="INSERT INTO `usuario`(`Nombre`, `Apellido`, `CC`, `Tipousuario`, `Password`) VALUES ('"+nombre+"','"+apellido+"','"+cc+"','"+tipousuario+"','"+password+"')";
